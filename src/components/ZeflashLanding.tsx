...
const ZeflashLanding: React.FC = () => {
  ...
  useEffect(() => {
    const sectionIds = ['what', 'features', 'how', 'science', 'who', 'why', 'pricing'];
    let ticking = false;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-blue-50/50 text-gray-900">
      ...
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-xl border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <SectionLink href="#pricing" label="Pricing" active={activeSection==='pricing'} />
          </nav>
      ...
      {/* Pricing Plans */}
      <section id="pricing" className="py-12 sm:py-16 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold">Flexible Testing Plans</h2>
